...
class EngineCall : public AcceptanceFixture {
 public:
  ...
  interface::types::EvmCalleeHexString callee{[] {
  ...
  */
  ...
  interface::types::EvmCodeHexString code{
  ...
  */
  ...
  interface::types::EvmCodeHexString inputCallSetter{
      "ee919d50"
  ...
  */
  ...
  interface::types::EvmCodeHexString inputCallGetter{"d46300fd"};
  ...
  */
  interface::types::EvmCodeHexString creatorStorageCode{
  ...
  // getCreator()
  interface::types::EvmCodeHexString getCreator{"0ee2cb10"};
  // getMsgSender()
  interface::types::EvmCodeHexString getMsgSender{"7a6ce2e1"};
};
  ...
  IntegrationTestFramework(1)
      ...
      .sendTx(complete(
          baseTx(kAdminId)
              ...
              .createAccount("evm", "evm", kEvmKeypair.publicKey()),
          kAdminKeypair))
      .skipProposal()
      .skipBlock()
      .sendTxAwait(
